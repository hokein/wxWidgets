...
wxDECLARE_EXPORTED_EVENT( WXDLLIMPEXP_WEBVIEW, wxEVT_WEBVIEW_DOWNLOAD_STARTED, wxWebViewEvent );
wxDECLARE_EXPORTED_EVENT( WXDLLIMPEXP_WEBVIEW, wxEVT_WEBVIEW_DOWNLOAD_COMPLETED, wxWebViewEvent );
...
#define EVT_WEBVIEW_DOWNLOAD_STARTED(id, fn) \
    wx__DECLARE_EVT1(wxEVT_WEBVIEW_DOWNLOAD_STARTED, id, \
                     wxWebViewEventHandler(fn))

#define EVT_WEBVIEW_DOWNLOAD_COMPLETED(id, fn) \
    wx__DECLARE_EVT1(wxEVT_WEBVIEW_DOWNLOAD_COMPLETED, id, \
                     wxWebViewEventHandler(fn))
...
#define wxEVT_COMMAND_WEBVIEW_DOWNLOAD_STARTED wxEVT_WEBVIEW_DOWNLOAD_STARTED
#define wxEVT_COMMAND_WEBVIEW_DOWNLOAD_COMPLETED wxEVT_WEBVIEW_DOWNLOAD_COMPLETED
